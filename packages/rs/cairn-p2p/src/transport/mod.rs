...
pub struct TransportConfig {
    ...
    /// Bootstrap nodes for DHT (Kademlia) peer discovery.
    /// Multiaddr strings like `/dnsaddr/bootstrap.libp2p.io/p2p/QmNnooDu7...`.
    /// When non-empty, the swarm will connect to these nodes on startup and
    /// initiate a Kademlia bootstrap to join the DHT.
